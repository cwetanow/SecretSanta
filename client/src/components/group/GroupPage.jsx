...
import { getGroupUsers, checkGroupOwner, removeUser, closeGroup, checkIsGroupClosed } from '../../actions/groupActions.js';
...
class GroupPage extends Component {
  ...
  componentDidMount() {
    ...
    this.props.checkIsGroupClosed(this.props.groupName);
  }
...
const mapDispatchToProps = (dispatch) => {
  return bindActionCreators({ getGroupUsers, checkGroupOwner, distributeGifts, getGift, removeUser, closeGroup, checkIsGroupClosed }, dispatch)
};
